        ...
        <div className="container mx-auto text-center">
          <ScrollAnimation direction="up">
            ...
            <p className="text-xl max-w-3xl mx-auto mb-8">
              Es el momento perfecto para complementar tu siembra con nuestros bioinsumos 
              revolucionarios y aprovechar estas ofertas por tiempo limitado.
            </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <ScrollAnimation direction="up" delay={0.3} className="mt-16">
            <div className="bg-green-50 border border-green-100 rounded-xl p-8 max-w-3xl mx-auto text-center">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">¿Necesitas asesoría?</h3>
              <p className="text-gray-700 mb-6">
                Si no estás seguro qué producto es el adecuado para tus necesidades específicas, 
          ...
          <ScrollAnimation direction="up">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Agricultores de todo el país ya están experimentando los beneficios de nuestros productos.
              </p>
            </div>
          </ScrollAnimation>
      ...
      <section className="py-16 bg-green-700 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <ScrollAnimation direction="up">
              <h2 className="text-3xl font-bold mb-6">¡No pierdas esta oportunidad!</h2>
              <p className="text-xl mb-8">
                La temporada de siembra es el momento perfecto para incorporar nuestros bioinsumos 
                y transformar tus cultivos. Esta oferta está disponible por tiempo limitado.
              </p>
              <motion.a 
                href="#" 
              ...
              <p className="mt-4 text-white/80 text-sm">
                *Los precios no incluyen gastos de envío. Consulta disponibilidad para tu región.
              </p>
            </ScrollAnimation>
          </div>
        </div>
